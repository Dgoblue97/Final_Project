...
programmers = [Student(a[0],a[1],a[2]) for a in student_tups_list]
...
prod_iter = map(Student.productivity,programmers)
...
names_and_productivities_zip = zip(names,prod_list)
